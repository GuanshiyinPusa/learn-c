...
// looped menu to let the user change parameters. The program should use the &
// operator and suitable masks to ensure that the ID and size entries are
// converted to the specified range.
