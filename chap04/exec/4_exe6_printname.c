...
corresponding name, as in the following: Melissa Honeybee 7   8 Next, have it
print the same information, but with the counts aligned with the beginning of
each name. Melissa Honeybee 7   8
*/
#include <stdio.h>
#include <string.h>
...
// Output:
// Enter your first name: Shuyuan
// Enter your last name: Gao
// Shuyuan Gao
//       7   3
// Shuyuan Gao
// 7       3
